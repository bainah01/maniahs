...
window.addEventListener?window.addEventListener("load",tambahCapchaMekaiEnak(mytext),!1):window.attachEvent?window.attachEvent("onload",tambahCapchaMekaiEnak(mytext)):window.onload=tambahCapchaMekaiEnak(mytext);
...
function tambahCapchaMekaiEnak(mytext){
_("demo").innerHTML = '<div class="g-recaptcha" data-sitekey="6Ldpa5EdAAAAAGYNC2WqCtl3vDwDtG8fMEjwNIxz" data-callback=\'RyanWikwiks(mytext);\'></div>';
}
